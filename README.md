...
> **Tip**: See [.env.example](.env.example) for the full list of variables (including the Phase 7 Vertex AI / Cloud Run vars) with detailed comments explaining each one. Production deploy steps are in [docs/DEPLOY.md](docs/DEPLOY.md); resume bullets in [docs/RESUME.md](docs/RESUME.md).
